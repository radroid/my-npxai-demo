	...
	return (
		<div className="mx-auto flex max-w-4xl flex-col gap-12 px-4 py-16 md:px-6">
			<header className="flex flex-col gap-4">
				...
				<p className="max-w-3xl text-[--text-muted] md:text-lg">
			...
			<div className="flex items-center gap-3 text-sm">
				<Link
					href="/knowledge-hub"
					className="inline-flex items-center gap-1 text-[--accent-brand] hover:text-[--text] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[--accent] rounded-sm"
				>
