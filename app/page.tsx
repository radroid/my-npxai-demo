	...
	return (
		<div className="mx-auto flex max-w-6xl flex-col gap-24 px-4 py-16 md:px-6 md:py-20">
			...
			<section className="flex flex-col items-center gap-6 text-center">
				...
				<h1 className="max-w-3xl text-balance font-semibold text-4xl leading-tight tracking-tight text-[--text] md:text-5xl lg:text-6xl">
				...
				<div className="mt-2 flex flex-col gap-3 sm:flex-row">
					<Link
						href="/knowledge-hub"
						className="inline-flex h-11 items-center justify-center gap-2 rounded-md bg-[--accent-brand] px-6 text-sm font-medium text-white transition-colors hover:bg-[--accent-brand-hover] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[--accent]"
					>
					...
					<Link
						href="/generator"
						className="inline-flex h-11 items-center justify-center gap-2 rounded-md border border-[--border] bg-[--surface] px-6 text-sm font-medium text-[--text] transition-colors hover:bg-[--surface-2] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[--accent]"
					>
				...
				<div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
					{FEATURES.map((f) => (
						<Link
							key={f.href}
							href={f.href}
							className="group flex flex-col gap-3 rounded-lg border border-[--border] bg-[--surface] p-5 transition-colors hover:border-[--accent-brand]/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[--accent]"
						>
							...
							<h3 className="font-semibold text-[--text] text-lg">{f.title}</h3>
							<p className="text-sm text-[--text-muted] leading-relaxed">
								{f.blurb}
							</p>
							<span className="mt-auto text-xs font-medium text-[--accent-brand]">
								{f.cta} →
							</span>
						</Link>
					))}
			...
			<section id="why" className="flex flex-col gap-6">
				<header className="flex flex-col gap-2">
					...
					<p className="max-w-3xl text-sm text-[--text-muted] md:text-base">
			...
			<section
				id="contact"
				className="flex flex-col items-center gap-4 rounded-xl border border-[--border] bg-[--surface] p-8 text-center md:p-12"
			>
				<p className="text-xs uppercase tracking-[0.18em] text-[--text-muted]">
					Stay in touch
				</p>
				<h2 className="max-w-2xl text-balance font-semibold text-2xl text-[--text] md:text-3xl">
