...
- **2026-07-13** — **Timelapse scaffolding removed.** `.timelapse.yaml` + `.gitignore` timelapse entries (from the frontend-evolution-timelapse experiment) deleted per Raj; the tool can regenerate its config on demand.
