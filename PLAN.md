...
**Phase 6 — Frontend overhaul** (opened 2026-04-17 night by Raj after a first pass through the app).
...
> When the current phase changes, update this section. Phases: 1 Setup → 2 Scaffolding → 3 RAG pipeline → 4 Full build → 5 Polish + ship → 6 Frontend overhaul.
