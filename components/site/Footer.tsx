...
export function Footer() {
	...
	return (
		<footer className="mt-16 border-t border-border bg-bg">
			<div className="mx-auto flex max-w-6xl flex-col items-start gap-3 px-4 py-8 text-xs text-fg-muted md:flex-row md:items-center md:justify-between md:px-6">
				<p>
					Built by{" "}
					<Link
						...
						className="text-fg underline-offset-4 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand rounded-sm"
					>
						Raj Dholakia
					</Link>{" "}
